...
const ProfileSvg = ({height, width, color}: React.SVGProps<SVGSVGElement>) => (
  <Svg
    width={width ? width : RFValue(24)}
    height={height ? height : RFValue(24)}
    viewBox="0 0 24 24">
    <Defs></Defs>
    <Path fill={'transparent'} opacity={0.001} d="M0 0h24v24H0z" />
    <Path
